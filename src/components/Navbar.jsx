    ...
    return (
        <nav className="navbar navbar-expand-lg navbar-light bg-nord1 ">
            <div className="container-fluid">
                <a className="navbar-brand text-nord4 main-page-text" href="#">DropDev</a>
                ...
                <div className="collapse navbar-collapse" id="navbarText">
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                        <li className="nav-item">
                            <a className="nav-link active text-nord4 main-page-text" aria-current="page" href="#About">About</a>
                        </li>
                        <li className="nav-item">
